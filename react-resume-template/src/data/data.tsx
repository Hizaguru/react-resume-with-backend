...
export const homePageMeta: HomepageMeta = {
  title: 'Jukka-Pekka Lappalainen | Full Stack Developer | Perttula, Finland',
  description:
    'Jukka-Pekka Lappalainen — Full Stack Developer based in Perttula, Finland. Experienced in React, TypeScript, Python, Java, AWS, and ethical hacking. Explore my portfolio and get in touch.',
  author: 'Jukka-Pekka Lappalainen',
  keywords:
    'Jukka-Pekka Lappalainen, Full Stack Developer, React, TypeScript, Python, Java, AWS, Perttula, Finland, portfolio, software engineer, web developer, ethical hacking',
...
export const aboutData: About = {
  ...
  aboutItems: [
    {label: 'Location', text: 'Perttula', Icon: MapIcon},
