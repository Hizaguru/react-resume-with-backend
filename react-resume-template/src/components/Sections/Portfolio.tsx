    ...
    <a
      ...
      <div className="relative h-full w-full p-4">
        <div className="flex h-full w-full flex-col gap-y-2 overflow-y-scroll">
          <h2 className="sm:text-4xl lg:text-xs text-center font-bold text-white opacity-100">{title}</h2>
          <p className="sm:text-4xl lg:text-xs text-white opacity-100 sm:text-sm">{description}</p>
        </div>
