              ...
              <div className="grid grid-cols-5 gap-8">
                {processSteps.map(({number, title, description}) => (
                  <div key={number} className="relative flex flex-col gap-y-4">
                    <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-accent font-mono text-sm font-bold text-white">
                      {number}
                    </div>
            ...
            <div className="relative flex flex-col gap-y-8">
              ...
              {processSteps.map(({number, title, description}) => (
                <div key={number} className="relative flex gap-x-6">
                  <div className="relative z-10 flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-accent font-mono text-sm font-bold text-white">
                    {number}
                  </div>
