...
export const aboutData: About = {
  ...
  I dedicate my spare time to honing my programming skills and working on various personal projects. This self-directed approach allowed me to explore different programming languages, frameworks, and technologies, equipping me with a versatile toolkit for software development.\n
  Beyond programming, I bring a unique perspective to my work, thanks to my extensive experience as a sound engineer. This background has exposed me to both software and hardware aspects, fostering a disciplined approach to troubleshooting and problem-solving. I'm excited to collaborate with like-minded professionals and contribute to cutting-edge projects.\n\n Feel free to explore my portfolio and get in touch if you're interested in partnering on an exciting venture or if you have any inquiries. Let's create something extraordinary together!`,
  aboutItems: [
